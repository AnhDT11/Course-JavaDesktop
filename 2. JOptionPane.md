...
| --- | --- |
|showConfirmDialog|Đặt câu hỏi xác nhận, như yes/no/cancel.|
|showInputDialog|Nhập một giá trị đầu vào.|
|showMessageDialog|Nói với người dùng về điều gì đó đã xảy ra.|
|showOptionDialog|-|
